...
if(isset($_SESSION['username']) && isset($_SESSION['password'])){
	...
	if($row!=0){
		echo "Click on \"Event id\" to edit the event!";
		...
		while($row1=mysqli_fetch_assoc($query)){
			...
			echo "<tr><td width='7%'><a href='edit.php?event_ids=$event_id&event_names=$event_name
			&dates=$date&times=$time&places=$place&descriptions=$description&users=&user'>$event_id</td>
